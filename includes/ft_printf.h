...
int					ft_strncmp(t_cc *s1, t_cc *s2, int n);
int					ft_strlen(t_cc *str);
char				*ft_strcpy(char *dst, t_cc *src);
char				*ft_strchr(t_cc *s, int c);
...
** print_lst.c
*/
int					print_lst(t_list *list, int limit, t_specif *bskt, int *i);
t_uc				*ft_strncpy(t_uc *dst, t_uc *src, size_t len);
